...
- The root of the State [Merkle Tree](/lpn/zk-coprocessor/verifiable-database-architecture/storage-database.mdx), computed in the previous section, that corresponds to this block number
