...
- **[State Database](state-database.mdx)**: Account state management and verification
- **[Storage Database](storage-database.mdx)**: Contract storage optimization and querying
- **[On-Chain Storage](onchain-storage.mdx)**: On-chain data integration and verification
