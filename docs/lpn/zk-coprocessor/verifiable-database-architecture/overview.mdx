...
:::note The following sections provide detailed technical information about each database component. This explanation requires knowledge of advanced data structures such as [Merkle Patricia Trees](/lpn/zk-coprocessor/verifiable-database-architecture/storage-database.mdx) and zero-knowledge proof systems.
:::
